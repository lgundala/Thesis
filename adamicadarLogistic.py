...
p1_9link = 0
p0_9link= 0
logreg = linear_model.LogisticRegression(C=1e5, class_weight='balanced', random_state = 435267)
for i in range(0,10):
    for j in range(0,5):
        ...
        probas_ = logreg.fit(X_tr,Y_tr).predict_proba(X_te)
...
f = open('wikiresultsExp1Logistic_adamicadar.csv','w')
f.write('using 2008\n')
