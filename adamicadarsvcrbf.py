...
p1_9link = 0
p0_9link= 0
clf = SVC(class_weight='balanced',probability=True, random_state = 43525,cache_size = 7000, shrinking = False, max_iter = 100)
for i in range(0,10):
    for j in range(0,5):
...
f = open('wikiresultsExp1svcrbf_adamicadar.csv','w')
f.write('using 2008\n')
